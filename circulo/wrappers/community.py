...
def comm_conga(G, ctx):
    return partial(circulo.algorithms.conga.CONGA, ensure_undirected(G, ctx)), False

def comm_congo(G, ctx):
    return  partial(circulo.algorithms.congo.CONGO, ensure_undirected(G, ctx)), False
